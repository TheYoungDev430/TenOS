skeepOS is a small operating system written in Python. It uses Windows to launch the programs inside it. WARNING: TskeepOS may not work due to you not having the .png files that it uses as its wallpaper
